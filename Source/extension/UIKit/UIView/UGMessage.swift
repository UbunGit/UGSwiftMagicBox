...
/// 配置消息提示框
func configGSMessage() {
//    GSMessage.infoBackgroundColor = .COLOR_B18AFF70
//    GSMessage.errorBackgroundColor = .COLOR_B18AFF70
//    GSMessage.successBackgroundColor = .COLOR_B18AFF70
...
extension UIView {
    ...
    open func ug_msginfo(_ text: String?,
                  options: [GSMessageOption]? = [.position(.bottom)]){
        GSMessage.showMessageAddedTo(text: text ?? "info", type: .info, options: options, inView: self, inViewController: nil)
    }
    /**
     * view上弹出error提示，默认在顶
     */
    open func ug_msgerror(_ text: String?,
        ...
        GSMessage.showMessageAddedTo(text: text ?? "error" as String, type: .error, options: options, inView: self, inViewController: nil)
    }
    /**
    ...
    open func ug_msgsuccess(_ text: String?,
        ...
        GSMessage.showMessageAddedTo(text: text ?? "success" as String, type: .success, options: options, inView: self, inViewController: nil)
    }
    ...
    func calculatePosition() {
        ...
        case .bottom:
            ...
            if let vc = inViewController {
                ...
                y -= margin.bottom
                if #available(iOS 11.0, *) {
                    offsetY -= inView.safeAreaInsets.bottom
                    y = inView.bounds.size.height - height + offsetY
                }
